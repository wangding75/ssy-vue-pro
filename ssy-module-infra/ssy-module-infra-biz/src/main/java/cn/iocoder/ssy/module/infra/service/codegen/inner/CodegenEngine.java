package cn.iocoder.ssy.module.infra.service.codegen.inner;
...
import cn.iocoder.ssy.framework.apilog.core.enums.OperateTypeEnum;
import cn.iocoder.ssy.framework.common.exception.util.ServiceExceptionUtil;
...
import cn.iocoder.ssy.framework.excel.core.annotations.DictFormat;
import cn.iocoder.ssy.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "ssy-module-${table.moduleName}/" + // 顶级模块
                "ssy-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "ssy-module-${table.moduleName}/" + // 顶级模块
                "ssy-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "ssy-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "ssy-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }

package cn.iocoder.ssy.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.iocoder.ssy.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = " Ssy，牛逼！")
    @ExcelProperty("结果提示")

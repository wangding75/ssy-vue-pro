package cn.iocoder.ssy.module.system.service.user;
...
import cn.iocoder.ssy.framework.common.util.collection.ArrayUtils;
...
import cn.iocoder.ssy.module.infra.api.file.FileApi;
import cn.iocoder.ssy.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.iocoder.ssy.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.iocoder.ssy.module.system.controller.admin.user.vo.user.*;
...
import cn.iocoder.ssy.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.iocoder.ssy.module.system.dal.mysql.dept.UserPostMapper;
import cn.iocoder.ssy.module.system.dal.mysql.user.AdminUserMapper;
import cn.iocoder.ssy.module.system.enums.common.SexEnum;
import cn.iocoder.ssy.module.system.service.dept.DeptService;
...
import cn.iocoder.ssy.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("ssyyuanma");
        ...
        assertEquals("ssyyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("ssyyuanma"))).thenReturn("java");

package cn.iocoder.ssy.module.pay.service.refund;

import cn.hutool.extra.spring.SpringUtil;
import cn.iocoder.ssy.framework.common.pojo.PageResult;
import cn.iocoder.ssy.framework.pay.core.client.PayClient;
import cn.iocoder.ssy.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import cn.iocoder.ssy.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import cn.iocoder.ssy.framework.pay.core.enums.channel.PayChannelEnum;
import cn.iocoder.ssy.framework.pay.core.enums.refund.PayRefundStatusRespEnum;
import cn.iocoder.ssy.framework.test.core.ut.BaseDbAndRedisUnitTest;
import cn.iocoder.ssy.module.pay.api.refund.dto.PayRefundCreateReqDTO;
import cn.iocoder.ssy.module.pay.controller.admin.refund.vo.PayRefundExportReqVO;
import cn.iocoder.ssy.module.pay.controller.admin.refund.vo.PayRefundPageReqVO;
...
import cn.iocoder.ssy.module.pay.dal.dataobject.refund.PayRefundDO;
import cn.iocoder.ssy.module.pay.dal.mysql.refund.PayRefundMapper;
import cn.iocoder.ssy.module.pay.dal.redis.no.PayNoRedisDAO;
import cn.iocoder.ssy.module.pay.enums.notify.PayNotifyTypeEnum;
import cn.iocoder.ssy.module.pay.enums.order.PayOrderStatusEnum;
import cn.iocoder.ssy.module.pay.enums.refund.PayRefundStatusEnum;
import cn.iocoder.ssy.module.pay.framework.pay.config.PayProperties;
import cn.iocoder.ssy.module.pay.service.app.PayAppService;
import cn.iocoder.ssy.module.pay.service.channel.PayChannelService;
...
import static cn.iocoder.ssy.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.iocoder.ssy.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.iocoder.ssy.framework.common.util.json.JsonUtils.toJsonString;
import static cn.iocoder.ssy.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.iocoder.ssy.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.iocoder.ssy.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.iocoder.ssy.framework.test.core.util.RandomUtils.randomPojo;
import static cn.iocoder.ssy.framework.test.core.util.RandomUtils.randomString;
import static cn.iocoder.ssy.module.pay.enums.ErrorCodeConstants.*;

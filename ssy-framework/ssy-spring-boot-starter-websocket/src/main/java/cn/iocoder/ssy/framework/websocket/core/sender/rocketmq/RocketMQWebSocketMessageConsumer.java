package cn.iocoder.ssy.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${ssy.websocket.sender-rocketmq.topic}",
        consumerGroup = "${ssy.websocket.sender-rocketmq.consumer-group}",

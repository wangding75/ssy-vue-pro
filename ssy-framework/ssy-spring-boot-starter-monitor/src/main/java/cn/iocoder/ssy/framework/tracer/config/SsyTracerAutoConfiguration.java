...
import cn.iocoder.ssy.framework.tracer.core.aop.BizTraceAspect;
import cn.iocoder.ssy.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "ssy.tracer", value = "enable", matchIfMissing = true)
public class SsyTracerAutoConfiguration {

package cn.iocoder.ssy.framework.desensitize.core;

import cn.iocoder.ssy.framework.common.util.json.JsonUtils;
import cn.iocoder.ssy.framework.desensitize.core.annotation.Address;
import cn.iocoder.ssy.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.iocoder.ssy.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.iocoder.ssy.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname(" Ssy");
        ...
        desensitizeDemo.setRegex("你好，我是 Ssy");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin(" Ssy");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = " Ssy", replacer = "*")
